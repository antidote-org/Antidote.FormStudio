...
let private classes : CssModules.ComponentFields.FormMessage = import "default" "./FormMessage.module.scss"


[<ReactComponent>]
let FormMessageField (messageInfo:MessageInfo) (props : Field.ReactComponentField.ReactComponentFieldProps) =

    let typeClass =
        match messageInfo.MessageType with
        | MessageType.Error -> [ "is-danger"; "is-light"; "has-background-danger-light" ]
        | MessageType.Warning -> [ "is-warning"; "is-light"; "has-background-warning-light" ]
        | MessageType.Info -> [ "is-info"; "is-light"; "has-background-info-light" ]
        | MessageType.Success -> [ "is-success"; "is-light"; "has-background-success-light" ]
        | MessageType.Danger -> [ "is-danger"; "is-light"; "has-background-danger-light" ]
                            ...
                            Html.div [
                                ...
                                prop.children [
                                    Html.span [
                                        ...
                                        prop.style [style.marginRight 7]
                                        prop.children [
                                            Html.i [ prop.className "fas fa-phone" ]
                                        ]
                                    ]
                                    Html.text (
