...
let ICD10Finder (props : Field.ReactComponentField.ReactComponentFieldProps) =
    ...
    let validateICD10 (icd10: ICD10) =
        if System.String.IsNullOrWhiteSpace icd10.Code
        then Error $"ICD10 Code cannot be empty for ID: {icd10.Id}"
        else Ok ()
    ...
    useDebounce(
        ...
        fun searchTerm ->
            ...
            then
                async {
                    setIsLoading true
                    let getICD10Request : Antidote.Core.V2.Domain.MedicalRegistry.Request.SearchMedicalRegistry =
                    ...
                    let! getICD10Result = Antidote.Client.API.EndPoints.medicalRegistry.SearchMedicalRegistry getICD10Request
                            ...
                            Html.div [
                                prop.style [
                                    style.border (
                                        ...
                                        borderStyle.solid,
                                        (
                                            if System.String.IsNullOrWhiteSpace icd10Code.Code
                                            then "red"
                                            else "blue"
                                        )
                                    )
                                ...
                                prop.children [
                                    ...
                                    Html.span [
                                        prop.style [ style.fontWeight 400 ]
