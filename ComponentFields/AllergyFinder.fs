...
let AllergyFinder (props : Field.ReactComponentField.ReactComponentFieldProps) =
    ...
    let validateAllergy (allergy: Allergy) =
        if System.String.IsNullOrWhiteSpace allergy.Name
        then Error $"Allergy Name cannot be empty for ID: {allergy.Id}"
        else Ok ()
        ...
        fun searchTerm ->
            ...
            then
                async {
                    ...
                    let getAllergiesRequest : Antidote.Core.V2.Domain.MedicalRegistry.Request.SearchMedicalRegistry =
                    ...
                    let! getAllergiesResult = Antidote.Client.API.EndPoints.medicalRegistry.SearchMedicalRegistry getAllergiesRequest
                    ...
                    | Antidote.Core.V2.Domain.MedicalRegistry.Response.SearchMedicalRegistry.InvalidRequest e ->
                        toast ( Html.div "Invalid request for searching allergies registry" ) |> ignore
                    | _ ->
                            ...
                            Html.div [
                                prop.style [
                                    style.border (
                                        ...
                                        borderStyle.solid,
                                        (
                                            if System.String.IsNullOrWhiteSpace selectedAllergy.Name
                                            then "red"
                                            else "blue"
                                        )
                                    )
                    ...
                    prop.children[
                        ...
                        then
                            Html.div [
                                prop.onClick ( fun _ -> () )
                                prop.children [
                                    Html.strong "No allergies found for search term."
