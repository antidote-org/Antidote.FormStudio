...
///
/// For example, Fable.Form.Studio.Bulma will render the groups horizontally.
///
...
/// The behaviour of the form is not altered but it can be rendered differently.
///
/// For example, Fable.Form.Studio.Bulma will the form in section with a border and the title display above.
///
