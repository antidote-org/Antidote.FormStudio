...
let private classes : CssModules.Compose.DynamicFormAsComponent = import "default" "./DynamicFormAsComponent.module.scss"
    ...
    Bulma.box [
        ...
        | FormComposeMode.ReadOnly ->
            React.fragment [
                Bulma.label [
                    size.isSize1
                    prop.children [ Html.text props.FormSpec.Title ]
                ]
                Html.table [
                    prop.classes [ "table"; "is-bordered"; "is-striped"; "is-narrow"; "is-hoverable"; "is-fullwidth" ]
                    prop.children [
                        Html.thead [
                            Html.tr [
                                Html.th "Question"
                                        ...
                                        Html.td [
                                            ...
                                            prop.children [
                                                Html.ul [
                                                    ...
                                                    | Single answer ->
                                                        if answer.Value.StartsWith("data:image")
                                                        then
                                                            Html.img [
