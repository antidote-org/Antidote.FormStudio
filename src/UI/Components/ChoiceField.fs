module Antidote.FormStudio.UI.Components.ChoiceField
...
let ChoiceFieldComponent (props: TextFieldComponentProps) =
    ...
    //         let newOption =
    //             Helper.createOption (optionDescription + " " + optionNumber) (optionNumber)

    //         let newFormField =
    //             Helper.createFormFieldWithOptions props.FormField [
    //                 newOption
    //             ]

    //         let newFormSpec =
    //             Helper.updateFormFieldInFormSpecStep newFormField props.FormStep props.FormSpec
    ...
    //                                     |> Array.skip 1
    //                                     |> Array.map (fun cols ->
    //                                         Helper.createOption cols[0] cols[1]
    //                                     )
    //                                     |> Array.sort
    //                                     |> Array.toList
