...
let ChoiceFieldComponent(props: TextFieldComponentProps) =
                                            ...
                                            Html.div [
                                                ...
                                                prop.children [
                                                    Html.input [
                                                        ...
                                                        prop.placeholder "Option"
                                                        prop.value option.Description
                                                        prop.onChange (fun (e:string) ->
                                                            let updatedOption = { option with Description = e }
                                                            let newFormField = Helper.updateOptionInField props.FormField updatedOption
                                                            let newFormSpec = Helper.updateFormFieldInFormSpecStep newFormField props.FormStep props.FormSpec
                                            ...
                                            Html.div [
                                                ...
                                                prop.children [
                                                    Html.input [
                                                        ...
                                                        prop.onChange (fun (e:string) ->
                                                            let updatedOption = { option with Value = e }
                                                            let newFormField = Helper.updateOptionInField props.FormField updatedOption
                                                            let newFormSpec = Helper.updateFormFieldInFormSpecStep newFormField props.FormStep props.FormSpec
                                            ...
                                            Html.div [
                                                ...
                                                prop.children [
                                                    Bulma.button.a [
                                                        //color.isDanger
                                                        prop.onClick (fun _ ->
                                                            let newFormField = Helper.deleteOptionInFormField props.FormField option
                                                            let newFormSpec = Helper.updateFormFieldInFormSpecStep newFormField props.FormStep props.FormSpec
                                                            props.OnChange newFormSpec
                                                        )
                                                        prop.children [
    ...
    React.fragment [
        ...
        |> List.mapi (fun i o -> renderOption i o) |> React.fragment
        ...
        Html.button [
            ...
            prop.onClick (fun _ ->
                ...
                let newOption = Helper.createOption (optionDescription + " " + optionNumber) (optionNumber)
                let newFormField = Helper.createFormFieldWithOptions props.FormField [ newOption ]
                let newFormSpec = Helper.updateFormFieldInFormSpecStep newFormField props.FormStep props.FormSpec
                            ...
                            prop.onInput (fun filesArray ->
                                ...
                                fileReader.onload <- (fun (e:Browser.Types.Event) ->
                                    ...
                                    let options =
                                        ...
                                        |> Array.skip 1
                                        |> Array.map (fun cols -> Helper.createOption cols[0] cols[1] )
                                        |> Array.sort
                                        |> Array.toList

                                    let newFormField = Helper.createFormFieldWithOptions props.FormField options
                                    let newFormSpec = Helper.updateFormFieldInFormSpecStep newFormField props.FormStep props.FormSpec
